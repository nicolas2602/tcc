...
<body>
    ...
    <div class="jumbotron container bg-light col-sm-6 rounded border border-dark" >
        ...
        <form class="form-signin" method="post" enctype="multipart/form-data">
            <h2 style="color:rgb(56, 52, 52)"><b><center>Excluir Produto</center></b></h2>
            ...
            <input type="hidden" name="img1" value="<?php echo $resultProd['foto_produto']?>" id="upload"><br/>
                ...
                <div class="row">
                    <div class="col">
                        <label for="inputEmail">Código do Produto </label>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input readonly="readonly" type="text" id="nome" class="form-control" name="prod" value="<?php echo $resultProd['NOME_PRODUTO']?>" required autofocus><br/>
                    </div>
                    
                    <div class="col">
                        <label for="inputEmail">Preço</label>
                        <input readonly="readonly" type="number" id="data" class="form-control" name="price" value="<?php echo $resultProd['preco']?>" required autofocus><br/>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                    <a href="carrinho.php" class="btn btn-lg btn-secondary btn-block" name="up">Voltar</a>
                    </div>
                    <div class="col">
                    <input type="submit" class="btn btn-lg btn-danger btn-block" value="Excluir" name="del" onclick="return confirm('Deseja excluir o produto?')"/>
                    </div>    
                </div>
