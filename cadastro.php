 ...
 <div class="jumbotron container bg-light col-sm-6 rounded border border-dark " >
           ...
           Cidade, Estado, termos de serviço,  -->   
            ...
            <label for="inputEmail">Endereço:</label>
                <input type="text" id="end" class="form-control" name="end" placeholder="Endereço" required autofocus><br/>

            <label for="inputEmail">Cidade:</label>
                <input type="text" id="city" class="form-control" name="city" placeholder="Cidade" required autofocus><br/>
            ...
            <label for="inputEmail">Telefone 1:</label>
                <input type="text" id="tel" class="form-control" name="tel" placeholder="Telefone (celular ou fixo)" required autofocus><br/>

            <label for="inputEmail">Telefone 2:</label>
                <input type="text" id="tel2" class="form-control" name="tel2" placeholder="Telefone 2 (opcional)"><br/>
           ...
           <label for="inputPassword">Senha:</label>
            ...
            <div class="input-group mb-3">
                ...
                <label for="inputEmail">CNPJ:</label>
                    <input type="text" id="cnpj" class="form-control" name="cnpj" placeholder="CNPJ" required><br/>
                
                <label for="inputEmail">Nome da empresa: </label>
                   <input type="text" id="nempresa" class="form-control" name="nempresa" placeholder="Nome da empresa" required><br/>
