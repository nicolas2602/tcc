...
<br/>
 ...
 <div class="jumbotron container bg-light col-sm-4 rounded border border-dark " >
            ...
            <label for="inputPassword">Repetir Senha</label>
                ...
                <img class="img-thumbnail mx-auto d-block" src="<?php echo $f['imagem']?>" width="210px" height="210px" id="img">
                <br/>
                <input type="file" name="f1" id="file" style="display:none;">
                <center>
                <button id="button" class="btn btn-primary" name="button" value="Upload" onclick="FileUpload();">
                ...
                <input type="hidden" name="img1" value="<?php echo $f['imagem']?>" id="upload">
